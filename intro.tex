...
\note{Kyle: We use weight almost everywhere except for a few times when we use capacity.
...
\note{Kyle: I'm assuming we're going for dependence on $n$ and then $g$ here.}
