...
\begin{TODO}
\begin{itemize}\cramped
\item We’re considering only undirected graphs, but we still need to talk about darts.
\item Consistent notation for system of (dual) arcs?  And everything else.
