...
\bigskip
\begin{TODO}\noindent
Jeff to do for “next week” (ha ha):
...
\item
Grochaw and Tucker-Foltz** (unpublished): Unique-Games-complete for $\Z_q$ coefficients, for sufficiently large $q$.  Thus, no PTAS for any $q$ unless UCG is false.
\end{itemize}
\end{TODO}

\subsection{New Results and Organization}

\note{New story starts here.} \color{PineGreen}
