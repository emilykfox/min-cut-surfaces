...
We next need an algorithm to compute a tight non-separating cycle; this is a modification of an algorithm by  Cabello \etal~\cite[Theorem 5.4]{cdem-fotc-10}, where they give an algorithm that runs in $O(n \log n)$ time for the same problem.  
