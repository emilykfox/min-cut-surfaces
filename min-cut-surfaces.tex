...
Now consider an even subgraph $H$.  We define the \emph{crossing parity} $x_i(H)$ as the sum of the crossing parities of the cycles in any cycle decomposition of $H$.  Again, we claim that this bit is independent of the choice of cycle decomposition.  Consider two cycle decompositions $\gamma_1, \dots, \gamma_k$ and $\delta_1, \dots, \delta_l$ of $H$.  Because the cycles in both decompositions traverse the same subset of edges, there are ribbon perturbations $\tilde\gamma_1, \dots, \tilde\gamma_k, \tilde{a}_1, \dots, \tilde{a}_\beta$ and $\tilde\delta_1, \dots, \tilde\delta_l, \tilde{a}_1, \dots, \tilde{a}_\beta$ that include identical perturbations of the arcs $a_i$ and that have identical orders with each edge ribbon.
