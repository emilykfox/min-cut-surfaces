...
Portions of this work done by different subsets of the authors appeared in~\cite{cen-mcshc-09},~\cite{en-mcsnc-11}, and~\cite{efn-gmcse-12}. \textbf{\color{red} Should we cite Kyle's dissertation also? The global min cut section is based on the simplified algorithm first described in the dissertation.}
}}
...
\author{
  ...
  \and
  Kyle Fox%
  \thanks{Institute for Computational and Experimental Research in Mathematics, Brown University; \url{kyle_fox@brown.edu}.
