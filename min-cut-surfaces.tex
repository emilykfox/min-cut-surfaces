...
\note{Still pending:
\begin{itemize}
\item Lemma \ref{lem:L_edges_tree_coforest}
\item Discussion of unique shortest paths near Lemma \ref{lem:multishort}
\item “This is weird” referee comment in Theorem \ref{thm:min-cycle}
\item Non-orientable???
\end{itemize}}
