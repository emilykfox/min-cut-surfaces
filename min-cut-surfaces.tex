...
\caption{Left: A cycle and an arc that share an edge in $G$.  Right: A closeup on the ribbon graph $G^\square$, with a perturbation of the cycle and arc that cross inside a vertex region.}
\end{figure}
