...
%\note{Kyle: So, there was a claim about literature that isn't true anymore thanks to Cora, Erin, Amir, and I.We give full details for the homology signatures via tree-coforest decompositions (but without thenice figures) in our JoCG paper on homology bases.I've amended the motivation to say the preliminary works were the first to give these details.}
We give these full details here completeness, and because as far as we are aware, no detailed description appears
...
%\note{Erin: I'm ok with it!  We can cite that if you want, I guess?}
